...
COPY . .
RUN python -m pip install --upgrade pip && apt-get update && apt-get install -y libgdal-dev && apt-get install -y gdal-bin python3-gdal && apt-get install libpq-dev -y && pip install -r requirements.txt
