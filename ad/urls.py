...
urlpatterns = [
   ...
   #path("like_list_create/", like_list_create, name="like_list_create"), point for test
    ...
    path('men_shoes_detail_generic/', MenShoesDetailGeneric.as_view(), name='men_shoes_detail_generic'),
    path('wemen_clothes_list/', WemenClothesList.as_view(),  name='wemen_clothes_list'),
    path('wemen_clothes_detail_generic/', WemenClothesDetailGeneric.as_view(),  name='wemen_clothes_detail_generic'),
    path('wemen_shoes_list/', WemenShoesList.as_view(),  name='wemen_shoes_list'),
    path('wemen_shoes_detail_generic/', WemenShoesDetailGeneric.as_view(),  name='wemen_shoes_detail_generic'),
    path('bagsknapsack_list/', BagsKnapsacksList.as_view(), name='bagsknapsack_list'),
    path('bagsknapsack_detail_generic/', BagsKnapsacksDetailGeneric.as_view(), name='bagsknapsack_detail_generic'),
    path('childclothesshoes_list/', ChildClothesShoesList.as_view(), name='childclothesshoes_list'),
    path('childclothesshoes_detail_generic/', ChildClothesShoesDetailGeneric.as_view(), name='childclothesshoes_detail_generic'),
