    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_ru', models.EmailField(help_text='Введите email, не более 254 символов', max_length=254, null=True, unique=True, verbose_name='Почта')),
                ('email_en', models.EmailField(help_text='Введите email, не более 254 символов', max_length=254, null=True, unique=True, verbose_name='Почта')),
                ('email_es', models.EmailField(help_text='Введите email, не более 254 символов', max_length=254, null=True, unique=True, verbose_name='Почта')),
                ('is_first', models.BooleanField(default=True, verbose_name='Первый вход')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count_attempts', models.PositiveSmallIntegerField(default=3, verbose_name='Попытки')),
                ('count_send_code', models.PositiveSmallIntegerField(default=3, verbose_name='Количество повторных отправок кода')),
